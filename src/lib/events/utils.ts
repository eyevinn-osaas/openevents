 ...
 */
export function buildPeopleCreateData(speakerNames: string[], jobTitles: string[], organizations: string[], photos?: string[], links?: string[]) {
